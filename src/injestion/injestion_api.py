...
download_fema_data(
    ...
    "disasterNumber,state,fipsStateCode,fipsCountyCode,declarationType,fyDeclared,designatedArea,incidentType,declarationDate,incidentBeginDate,incidentEndDate,ihProgramDeclared,iaProgramDeclared,paProgramDeclared,hmProgramDeclared,tribalRequest",
